...
# Checkpoint configuration (Corellate with run_spec_from_ckpt.sh)
...
if [[ "$ARGC" != 1 ]]; then # Bad number of arguments.
   ...
   echo ""
    ...
    echo ""
    echo "USAGE: ckptscript.sh <BENCHMARK>"
    echo "EXAMPLE: ./ckptscript.sh perlbench"
    echo ""
...
OUTPUT_DIR=$GEM5_PERF_ROOT/output/checkpoints/${CHECKPOINT_CONFIG}/$BENCHMARK-1-ref-x86
