...
x264_s.executable = 'x264_s' + gem5-suffix
...
xz_s.executable = 'xz_s' + gem5-suffix
...
cam4_r.executable = 'cam4_r' + gem5-suffix
cam4_r.cmd = [cam4_r.executable]

#627.cam4_s     
cam4_s = Process(pid = 627) 
cam4_s.executable = 'cam4_s' + gem5-suffix
cam4_s.cmd = [cam4_s.executable]

#628.pop2_s       
pop2_s = Process(pid = 628) 
pop2_s.executable = 'speed_pop2' + gem5-suffix
pop2_s.cmd = [pop2_s.executable]

#538.imagick_r    
imagick_r = Process(pid = 538) 
imagick_r.executable = 'imagick_r' + gem5-suffix
...
imagick_s.executable = 'imagick_s' + gem5-suffix
